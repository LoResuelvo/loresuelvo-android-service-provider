...
fun OptionalIdentityVerificationScreen(
    ...
    Surface(
        ...
        Column(
            ...
            IdentityCardIllustration(modifier = Modifier.padding(top = 32.dp))
        }
    }
}

@Composable
private fun IdentityCardIllustration(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
            .fillMaxWidth()
        ...
        Box(modifier = Modifier.size(width = 164.dp, height = 108.dp), contentAlignment = Alignment.Center) {
            Surface(
                modifier = Modifier.size(width = 148.dp, height = 92.dp),
...
@Preview(showBackground = true, name = "Identity verification · phone", locale = "es")
@Preview(showBackground = true, name = "Identity verification · English device", widthDp = 320, heightDp = 640, locale = "en")
@Composable
private fun OptionalIdentityVerificationScreenPreview() {
